...
export function RecordingUpload({ patientId }: RecordingUploadProps) {
  ...
  const generateUploadUrl = useMutation(
    api.diagnosisDocuments.generateUploadUrl
  );
  const createDiagnosisDocument = useMutation(
    api.diagnosisDocuments.createDiagnosisDocument
  );
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          All audio formats supported • Max 5MB
        </p>
      </div>
